...
function Edit(props) {
  ...
  var updateUser = function updateUser(event) {
    ...
    setLoading(true);
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'inertia-react'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).patch("/users/".concat(props.user.id), {
      name: name,
      email: email
    }).then(function () {
      setLoading(false);
  ...
  var deleteUser = function deleteUser(event) {
    ...
    if (confirm('Are you sure you want to delete this contact?')) {
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'inertia-react'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())["delete"]("/users/".concat(props.user.id)).then(function () {});
    }
  };
