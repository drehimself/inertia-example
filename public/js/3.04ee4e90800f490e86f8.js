...
/* harmony import */ var inertia_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! inertia-react */ "./node_modules/inertia-react/src/index.js");
...
function Create(props) {
  ...
  var createUser = function createUser(event) {
    ...
    inertia_react__WEBPACK_IMPORTED_MODULE_2__["Inertia"].post('/users', {
      name: name,
      email: email,
      password: password
    }).then(function () {// code
